!/bin/bash
# Based on a script from https://github.com/Altarix/twitter-kit-ios
...
for ((i = 0; i < ${#PROJECTS_NAMES[@]}; i++)); do
    ...
    for PLATFORM in "${PLATFORM_NAMES[@]}"; do
        ...
        OUTPUT_DIR_FRAMEWORK="./RELEASE/$SCHEME_NAME.framework"
        createOrCleanDirectory "$OUTPUT_DIR_FRAMEWORK"
        ...
        copyToOutputDirectory $OUTPUT_DIR_FRAMEWORK $UNIVERSAL_FRAMEWORK_FOLDER
    done
